...
export default function April122024() {
    const selectDir = path.join(process.cwd(), 'public', 'photography', '11-3-2026');
        ...
        <div className="flex flex-col h-full bg-stone-50 font-[Geist_Mono] dark:bg-stone-900 selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <div className="px-15 sm:px-30 pt-5 pb-30">
                <div className="flex flex-col justify-start">
                    ...
                    <div className="text-2xl sm:text-3xl font-medium pt-2 sm:pt-5">11 March, 2026</div>
                    <div className="flex flex-row items-center pl-5 pt-2">
                        <span className="text-stone-800/75 dark:text-stone-200/75">Innocell | Hong Kong; Qianhai | Shenzhen</span>
                    </div>
                </div>
                <ImageGallery images={imageFiles} basePath="/photography/11-3-2026" />
            </div>
            <BackToTop />
        </div>
    );
