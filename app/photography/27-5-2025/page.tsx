...
export default function May272025() {
    const selectDir = path.join(process.cwd(), 'public', 'photography', '27-5-2025');
        ...
        <div className="flex flex-col h-full bg-stone-50 font-[Geist_Mono] dark:bg-stone-900 selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <div className="px-15 sm:px-30 pt-5 pb-30">
                <div className="flex flex-col justify-start">
                    ...
                    <div className="text-2xl sm:text-3xl font-medium pt-2 sm:pt-5">May 27, 2025</div>
                    <div className="flex flex-row items-center pl-5 pt-2">
                        <span className="text-stone-800/75 dark:text-stone-200/75">Sai Ying Pun; Aberdeen | Hong Kong</span>
                    </div>
                </div>
                <ImageGallery images={imageFiles} basePath="/photography/27-5-2025" />
            </div>
            <BackToTop />
        </div>
    );
