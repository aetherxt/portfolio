...
export default function Nagoya23() {
    const selectDir = path.join(process.cwd(), 'public', 'photography', 'Nagoya23');
            ...
            <div className="px-15 sm:px-30 pt-5 pb-30">
                <div className="flex flex-col justify-start">
                    ...
                    <div className="flex flex-row items-center pl-5 pt-2">
                        <span className="text-stone-800/75 dark:text-stone-200/75">Nagoya; Shirakawa; Kanazawa; Kaga | Japan</span>
                    </div>
                </div>
