...
export default function HKMisc() {
    const selectDir = path.join(process.cwd(), 'public', 'photography', 'HKMisc');
        ...
        <div className="flex flex-col h-full bg-stone-50 font-[Geist_Mono] dark:bg-stone-900 selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <div className="px-15 sm:px-30 pt-5 pb-30">
                <div className="flex flex-col justify-start gap-2 sm:gap-4">
                    ...
                    <div className="text-2xl sm:text-3xl font-medium">HK Misc</div>
                </div>
                <ImageGallery images={imageFiles} basePath="/photography/HKMisc" />
            </div>
            <BackToTop />
        </div>
    );
